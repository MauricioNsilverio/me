        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Maurício Nogueira Silvério</a></h1>
              <span className="email"><i className="icon-mail"></i> mauricionsilverio@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li><a href="https://www.facebook.com/mauricio.nogueirasilverio" target="_blank" rel="noopener noreferrer"><i className="icon-facebook2" /></a></li>
                {/* <li><a href="https://twitter.com/ddbarochiya" target="_blank" rel="noopener noreferrer"><i className="icon-twitter2" /></a></li> */}
                <li><a href="https://www.instagram.com/mauricionsilverio" target="_blank" rel="noopener noreferrer"><i className="icon-instagram" /></a></li>
                <li><a href="https://www.linkedin.com/in/mauricionsilverio" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
